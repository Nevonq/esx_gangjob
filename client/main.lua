...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{label = _U('gang_wear'), uniform ='gang_wear'}
...
function OpenArmoryMenu(station)
	...
	if Config.OxInventory then
		exports.ox_inventory:openInventory('stash', {id = 'society_gang', owner = station})
	...
	ESX.TriggerServerCallback('esx_gangjob:getFineList', function(fines)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'fine_category', {
			...
			if Config.EnablePlayerManagement then
				TriggerServerEvent('erjsdrgfg:sendBill', GetPlayerServerId(player), 'society_gang', _U('fine_total', data.current.fineLabel), data.current.amount)
			else
				TriggerServerEvent('erjsdrgfg:sendBill', GetPlayerServerId(player), '', _U('fine_total', data.current.fineLabel), data.current.amount)
			end
...
function OpenUnpaidBillsMenu(player)
	...
	ESX.TriggerServerCallback('erjsdrgfg:getTargetBills', function(bills)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'matiiautas', {
