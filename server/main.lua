...
ESX.RegisterServerCallback('esx_gangjob:storeNearbyVehicle', function(source, cb, plates)
	local xPlayer = ESX.GetPlayerFromId(source)
...
AddEventHandler('esx_gangjob:forceBlip', function()
	for _, xPlayer in pairs(ESX.GetExtendedPlayers('job', 'gang')) do
		TriggerClientEvent('esx_gangjob:updateBlip', xPlayer.source)
	end
end)
